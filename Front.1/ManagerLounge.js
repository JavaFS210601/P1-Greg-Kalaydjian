...
document.getElementById('filterTicketsUnresolved').addEventListener('click', filterTicketsUnresolvedFunc);
document.getElementById('filterTicketsAccepted').addEventListener('click', filterTicketsAcceptedFunc);
document.getElementById('filterTicketsDeclined').addEventListener('click', filterTicketsDeclinedFunc);
document.getElementById('acceptDenyButton').addEventListener('click', updateTicketFunc);
...
async function filterTicketsUnresolvedFunc() { //async returns a promise (which fetch returns)
...
async function filterTicketsAcceptedFunc() { //async returns a promise (which fetch returns)
...
async function filterTicketsDeclinedFunc() { //async returns a promise (which fetch returns)
